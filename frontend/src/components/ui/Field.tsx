...
const control =
  "min-h-[44px] w-full rounded-lg border border-border bg-surface px-3 text-[15px] font-medium text-ink placeholder:text-ink-faint focus:border-brick focus:outline-none focus-visible:ring-2 focus-visible:ring-brick/30";
