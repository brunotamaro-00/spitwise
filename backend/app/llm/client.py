...
_SYSTEM = (
    ...
    "- 'question': pregunta sobre gastos, saldos o el registro ('¿cuánto gastamos "
    "en Roma?', 'dame el detalle', '¿quién debe plata?', '¿cuándo llegamos a "
    "París?'), o un saludo/charla ('hola', 'gracias', '¿cómo te uso?'). REGLA: si "
    "el mensaje CARGA un gasto (tiene monto y algo comprado/pagado), es 'expense', "
    "nunca 'question'.\n"
    "- 'trip_question': pregunta sobre el CONTENIDO del viaje, lo que dirían las "
    ...
    "pregunta es de PLATA o del registro de gastos (cuánto gastamos/pagó/debe), "
    "es 'question' aunque nombre una ciudad; si carga un gasto, es 'expense'.\n"
