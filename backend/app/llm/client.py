...
_SYSTEM = (
    ...
    "- 'question': pregunta sobre gastos, saldos, el registro o el PRESUPUESTO "
    "('¿cuánto gastamos en Roma?', 'dame el detalle', '¿quién debe plata?', "
    "'¿cuándo llegamos a París?', '¿vamos bien?', '¿nos estamos pasando?', "
    "'¿cuánto podemos gastar por día?', '¿podemos salir a comer?'), o un "
    "saludo/charla ('hola', 'gracias', '¿cómo te uso?'). REGLA: si "
